...
@RestController
public class CalculateEvenNumberController {

    // Write a code to calculate the even number between 1 and 100
    ...
    @RequestMapping("/even") // endpoint
    public String calculateEvenNumber(){
       ...
       // Syntax for for_loop : for (Initialization; condition; increment or decrement){code}
        ...
        for(int i =1 ; i<=100; i++){
         ...
         // Here used if statement , modulus operator and == operator (equal-equal operator)
